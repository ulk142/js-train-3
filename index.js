...
function isAlmostSame(num1, num2) {
  ...
  if (num1 - num1 <= Number.EPSILON && num2 - num1 <= Number.EPSILON) {
    return true;
  }
  return false;
}
...
// Задача 6_1: Напишіть функцію, яка перевіряє, чи є число більше 0, але все ще більшим за Number.MIN_VALUE
console.log("Завдання 6_1 ====================================");
console.log(
...
console.log("isAlmostZero(Number.MIN_VALUE)", isAlmostZero(Number.MIN_VALUE+1)); // Виведе true
